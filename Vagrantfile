...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    mkdir -p /home/vagrant/go/src/github.com/kingblockio
    ln -s /vagrant /home/vagrant/go/src/github.com/kingblockio/kingblock

    chown -R vagrant:vagrant /home/vagrant/go
    chown vagrant:vagrant /home/vagrant/.bash_profile

    su - vagrant -c 'source /home/vagrant/.bash_profile'
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/kingblockio/kingblock && make get_tools'
  SHELL
end
